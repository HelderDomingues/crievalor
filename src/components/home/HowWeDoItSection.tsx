...
import { Target, Brain, Zap, Users, Award, Heart, ArrowRight, CheckCircle } from "lucide-react";
...
const HowWeDoItSection = () => {
  const pillars = [
    {
      ...
      details:
        "Não acreditamos em soluções genéricas. Cada estratégia é construída após análise minuciosa do seu negócio.",
    },
    {
      icon: Brain,
      title: "Metodologias Próprias",
      description: "Mar, Lumia e outros processos testados em +200 empresas diferentes.",
  ...
  return (
    <section
      className="py-16 md:py-24 relative bg-gradient-to-b from-secondary/10 via-background to-primary/5"
      id="como-fazemos"
      aria-labelledby="comoFazemosHeading"
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p
            className="text-lg md:text-xl text-muted-foreground max-w-4xl mx-auto animate-fade-in"
            style={{ animationDelay: "0.2s" }}
          >
            Nosso processo único combina <strong>metodologia proprietária</strong>, <strong>tecnologia avançada</strong>{" "}
            e<strong> expertise humana</strong> para transformar empresas em organizações de alto rendimento.
          </p>
        </div>
            ...
            >
              <CardContent className="p-8">
                <div className="flex flex-col h-full">
                  ...
                  <p className="text-sm text-foreground/80 mt-auto pt-4 border-t border-border/50">{pillar.details}</p>
                </div>
              </CardContent>
            </Card>
          ))}
        ...
        {/* Process Flow */}
        <div
          className="bg-card border border-border rounded-2xl p-8 md:p-12 mb-12 animate-fade-in"
          style={{ animationDelay: "0.8s" }}
        >
          <div className="text-center mb-8">
            <h3 className="text-2xl md:text-3xl font-bold mb-4">Do Diagnóstico aos Resultados</h3>
