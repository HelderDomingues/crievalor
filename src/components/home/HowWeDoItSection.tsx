...
const HowWeDoItSection = () => {
  ...
  return <section className="py-16 md:py-24 relative bg-gradient-to-b from-secondary/10 via-background to-primary/5" id="como-fazemos" aria-labelledby="comoFazemosHeading">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-4xl mx-auto animate-fade-in" style={{
          animationDelay: "0.2s"
        }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {pillars.map((pillar, index) => <Card key={index} className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 bg-background/50 backdrop-blur-sm border border-border hover:border-primary/20 animate-fade-in" style={{
