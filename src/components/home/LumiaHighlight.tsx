...
const LumiaHighlight = () => {
  return (
    <section
      className="py-16 md:py-24 relative bg-gradient-to-b from-secondary/20 to-background"
      id="lumia-produto"
      aria-labelledby="lumiaProdutoHeading"
    >
      <div className="absolute inset-0 overflow-hidden">
        <div
          className="blur-dot w-72 h-72 -top-36 -left-36 opacity-10"
          style={{ background: "linear-gradient(135deg, hsl(280, 75%, 65%), hsl(260, 70%, 60%))" }}
        ></div>
        <div
          className="blur-dot w-96 h-96 -bottom-48 -right-48 opacity-10"
          style={{ background: "linear-gradient(135deg, hsl(260, 75%, 65%), hsl(240, 70%, 60%))" }}
        ></div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12">
          ...
          >
            Consultores virtuais em <strong>Vendas, Marketing, Operações, RH, Gestão e Finanças</strong> — calibrados
            pelo MAR e guiados pelo seu Por Quê.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="order-1 lg:order-1 animate-fade-in" style={{ animationDelay: "0.3s" }}>
            ...
            <h3 className="text-2xl md:text-3xl font-bold mb-4">O Lumia conecta sua estratégia à prática</h3>
            <p className="text-lg text-muted-foreground mb-6">
              Reúne dados, contexto e metodologia em um sistema que gera recomendações acionáveis, acompanha resultados
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Recomendações práticas alinhadas às prioridades do MAR
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Vendas, Marketing, Operações, RH, Gestão e Finanças</p>
                </div>
              </div>
