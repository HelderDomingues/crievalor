...
const PartnersSection: React.FC = () => {
  return (
    <section id="parceiros" className="py-16 bg-white" aria-labelledby="parceirosHeading">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-4xl mx-auto">
          {partners.map((partner) => (
            <a 
              ...
              className="flex flex-col items-center justify-center p-6 bg-card hover:bg-accent/10 rounded-lg border border-border transition-colors duration-300"
