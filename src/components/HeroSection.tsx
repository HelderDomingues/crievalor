    ...
    <section className="relative min-h-screen flex items-center overflow-hidden pt-16">
      ...
      {isMarHero && (
        <>
          ...
          <div className="absolute bottom-1/4 right-10 md:right-20 z-20 animate-float opacity-20 hidden md:block" style={{ animationDelay: "1s" }}>
            <BarChart3 size={80} className="text-primary" />
          </div>
          <div className="absolute top-2/3 left-1/4 z-20 animate-float opacity-20 hidden md:block" style={{ animationDelay: "2s" }}>
