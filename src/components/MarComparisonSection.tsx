...
const MarComparisonSection = () => {
  ...
  const comparisonItems = [{
    ...
    title: "Investimento",
    mar: {
      value: "R$ 3.497,00 ou 10x de R$ 349,70",
      description: "10% de desconto à vista: R$ 3.147,30"
    },
    traditional: {
    ...
    <div className="container mx-auto px-4 relative z-10">
      ...
      <div className="max-w-3xl mx-auto text-center bg-card rounded-xl p-8 border border-border shadow-lg glow-border">
        ...
        <p className="text-sm text-muted-foreground mt-6">
          "Faturávamos entre 600 e 800 mil, mas sem controle nem previsibilidade. O MAR ajudou a ajustar processos, metas e margens. Em um ano crescemos cerca de 30% e ultrapassamos a casa do milhão com consistência."
          <br />
          <span className="font-medium">— Carlos Jose Alencar Rodrigues, Primeira Linha Acabamentos</span>
        </p>
      </div>
    </div>
  </section>;
